 ...
 *
 * Required for showing the timer in the Wear OS Recents list. Uses StopwatchPart so the system
 * auto-updates the timer - no periodic wake-ups needed.
 */
class OngoingActivityService : Service(), KoinComponent {
  ...
  companion object {
    ...
    fun createStopIntent(context: Context): Intent =
      Intent(context, OngoingActivityService::class.java).apply { action = ACTION_STOP }
  }
}
