...
interface SettingsRepository {
  ...
  /**
   * Bedtime stored as minutes from midnight. For times after midnight (e.g., 12:30 AM), we store as
   * next-day value (e.g., 30 for 00:30). Default is 1320 (10:00 PM).
   */
  ...
  /**
   * Fixed fasting start time stored as minutes from midnight. Default is 1140 (7:00 PM). Only used
   * when smartReminderMode is FIXED_TIME.
   */
  val fixedFastingStartMinutes: Flow<Int>
