 ...
 *
 * @property suggestedTimeMillis The absolute timestamp (in UTC milliseconds) when the fast should
 *   start.
 * @property suggestedTimeMinutes The time of day as minutes from midnight (0-1439) for display
 *   purposes.
