 ...
 *
 * This data class is the primary model for the user's real-time status. It is persisted in Jetpack
 * DataStore and serves as the single source of truth for the application's UI.
 *
